...
type MeasureInWindowCallback = (left: number, top: number, width: number, height: number) => void; // Mixin to HTMLElement that represents additions from the `usePlatformMethods` hook
