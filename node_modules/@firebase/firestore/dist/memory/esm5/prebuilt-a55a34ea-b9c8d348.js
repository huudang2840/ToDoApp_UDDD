 ...
 */ function D(t) {
    ...
    if (N.logLevel <= d.DEBUG) {
        var i = e.map(C);
        N.debug.apply(N, r([ "Firestore (8.10.1): " + t ], i));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= d.ERROR) {
        var i = e.map(C);
        N.error.apply(N, r([ "Firestore (8.10.1): " + t ], i));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= d.WARN) {
        var i = e.map(C);
        N.warn.apply(N, r([ "Firestore (8.10.1): " + t ], i));
    }
}
...
}(K), W = /^[_a-zA-Z][_a-zA-Z0-9]*$/, z = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
 ...
 */ function Xt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new qt(n)), e.p.push(new qt(z.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Qt(e) || Wt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (S() <= d.DEBUG && D("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ee(e)), 
                ...
                return r && mi(t).pr ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return xe(i = r.code) && i !== I.ABORTED ? (e = t.Fr.shift(), 
 ...
 */ function yi(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = P(t), r ? (e.Or.delete(2 /* IsSecondary */), [ 4 /*yield*/ , zr(e) ]) : [ 3 /*break*/ , 2 ];
 ...
 */;
              ...
              case 1:
                return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = P(t), i = q.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), tn());
                ...
                switch (n.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Wi(e.syncEngine, t, 1 /* SharedClientState */);
                        ...
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  ...
                                  case 2:
                                    return n.sent(), e.Or.delete(3 /* CredentialChange */), [ 4 /*yield*/ , zr(e) ];
 ...
 */ function Xo(t, e) {
    ...
    if (t = h(t), Mo("collection", "path", e), t instanceof Wo) return Bo(n = Q.fromString.apply(Q, r([ e ], i))), 
 ...
 */ function Jo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), Mo("doc", "path", e), t instanceof Wo) return xo(n = Q.fromString.apply(Q, r([ e ], i))), 
    new zo(t, 
    /* converter= */ null, new ot(n));
    if (!(t instanceof zo || t instanceof Yo)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return xo(n = t._path.child(Q.fromString.apply(Q, r([ e ], i)))), new zo(t.firestore, t instanceof Yo ? t.converter : null, new ot(n));
}
 ...
 * Firestore database.
 */ function Zo(t, e) {
    return t = h(t), e = h(e), (t instanceof zo || t instanceof Yo) && (e instanceof zo || e instanceof Yo) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function Rs(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof q || t instanceof hs || t instanceof as || t instanceof zo || t instanceof cs);
}
 ...
 */ function hu(t, e, n) {
    ...
    return du(r, [ gs(ms(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Ee.none()) ]);
}
 ...
 */ function fu(t) {
    ...
    if (t instanceof zo) f = Go(t.firestore, is), d = Kt(t._key.path), l = {
        next: function(e) {
            s[c] && s[c](pu(f, t, e));
        },
        error: s[c + 1],
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function vu() {
...
/** Immutable class holding a blob (binary data) */ var gu = /** @class */ function() {
    function t(t) {
        this._delegate = t;
    }
    return t.fromBase64String = function(e) {
        return mu(), new t(as.fromBase64String(e));
    }, t.fromUint8Array = function(e) {
        return vu(), new t(as.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return mu(), this._delegate.toBase64();
    }, t.prototype.toUint8Array = function() {
        return vu(), this._delegate.toUint8Array();
    }, t.prototype.isEqual = function(t) {
        return this._delegate.isEqual(t._delegate);
    }, t.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, t;
}(), wu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", bu = /** @class */ function() {
    function t() {}
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        throw new A(I.FAILED_PRECONDITION, wu);
 ...
 */;
        ...
        try {
            ...
            throw Du(t, "collection()", "Firestore.collection()");
        }
    }, t.prototype.doc = function(t) {
        try {
            return new Su(this, Jo(this._delegate, t));
        } catch (t) {
            throw Du(t, "doc()", "Firestore.doc()");
        }
    }, t.prototype.collectionGroup = function(t) {
        try {
            return new Ou(this, function(t, e) {
 ...
 */
            ...
            throw Du(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
        ...
        var t = this;
        return os(this._delegate), new Au(new uu(this._delegate, (function(e) {
            return du(t._delegate, e);
        })));
    ...
    return t(n, e), n.prototype.convertBytes = function(t) {
        return new gu(new as(t));
    }, n.prototype.convertReference = function(t) {
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Su.eu(e, this.firestore, /* converter= */ null);
    }, n;
}(iu);
 ...
 */ var Iu = /** @class */ function() {
    function t(t, e) {
        this._firestore = t, this._delegate = e, this._userDataWriter = new Eu(t);
    }
    return t.prototype.get = function(t) {
        var e = this, n = Mu(t);
        return this._delegate.get(n).then((function(t) {
            return new Cu(e._firestore, new Bs(e._firestore._delegate, e._userDataWriter, t._key, t._document, t.metadata, n.converter));
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Mu(t);
    ...
    return t.prototype.fromFirestore = function(t, e) {
        ...
        /* converter= */ null);
        return this._delegate.fromFirestore(new Lu(this._firestore, n), null != e ? e : {});
    ...
    t.nu = function(e, n) {
        ...
        var o = i.get(n);
        return o || (o = new t(e, new Eu(e), n), i.set(n, o)), o;
    }, t;
}();
...
var Su = /** @class */ function() {
    function t(t, e) {
        this.firestore = t, this._delegate = e, this._userDataWriter = new Eu(t);
    }
    return t.iu = function(e, n, r) {
        ...
        try {
            ...
            throw Du(t, "collection()", "DocumentReference.collection()");
        }
    }, t.prototype.isEqual = function(t) {
        return (t = h(t)) instanceof zo && Zo(this._delegate, t);
    }, t.prototype.set = function(t, e) {
        e = Uo("DocumentReference.set", e);
        try {
            return e ? hu(this._delegate, t, e) : hu(this._delegate, t);
        } catch (t) {
            throw Du(t, "setDoc()", "DocumentReference.set()");
        }
    }, t.prototype.update = function(t, e) {
        for (var n = [], i = 2; i < arguments.length; i++) n[i - 2] = arguments[i];
        try {
            return 1 === arguments.length ? lu(this._delegate, t) : lu.apply(void 0, r([ this._delegate, t, e ], n));
        } catch (t) {
            throw Du(t, "updateDoc()", "DocumentReference.update()");
        }
    }, t.prototype.delete = function() {
        return du(Go((t = this._delegate).firestore, is), [ new Me(t._key, Ee.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        var r = ku(e), i = Ru(e, (function(e) {
            return new Cu(t.firestore, new Bs(t.firestore._delegate, t._userDataWriter, e._key, e._document, e.metadata, t._delegate.converter));
        }));
        return fu(this._delegate, r, i);
    }, t.prototype.get = function(t) {
        var r = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return new Cu(r.firestore, new Bs(r.firestore._delegate, r._userDataWriter, t._key, t._document, t.metadata, r._delegate.converter));
        }));
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Nu.nu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Cu = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "ref", {
        get: function() {
            return new Su(this._firestore, this._delegate.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "id", {
    ...
    return t.prototype.where = function(e, n, r) {
        try {
            ...
            throw Du(e, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            throw Du(e, "limitToLast()", "Query.limitToLast()");
        }
        ...
        try {
            ...
            throw Du(e, "startAt()", "Query.startAt()");
        }
        ...
        try {
            ...
            throw Du(e, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            ...
            throw Du(e, "endBefore()", "Query.endBefore()");
        }
     ...
     */
        function(t) {
            ...
            return new Vu(r.firestore, new Gs(r.firestore._delegate, r._userDataWriter, r._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = ku(e), i = Ru(e, (function(e) {
            return new Vu(t.firestore, new Gs(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return fu(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Nu.nu(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(t.prototype, "type", {
        ...
        get: function() {
            return new Lu(this._firestore, this._delegate.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Ou(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "metadata", {
        ...
        return this._delegate.docChanges(t).map((function(t) {
            return new Pu(e._firestore, t);
        }));
    }, t.prototype.forEach = function(t, e) {
        var n = this;
        this._delegate.forEach((function(r) {
            t.call(e, new Lu(n._firestore, r));
        }));
    }, t.prototype.isEqual = function(t) {
        return Qs(this._delegate, t._delegate);
    }, t;
    ...
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t ? new Su(this.firestore, t) : null;
        },
        enumerable: !1,
        configurable: !0
    }), n.prototype.doc = function(t) {
        try {
            return new Su(this.firestore, void 0 === t ? Jo(this._delegate) : Jo(this._delegate, t));
        } catch (t) {
            throw Du(t, "doc()", "CollectionReference.doc()");
        }
    }, n.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = Go(t.firestore, is), r = Jo(t), i = ou(t.converter, e);
            return du(n, [ gs(ms(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, Ee.exists(!1)) ]).then((function() {
                return r;
            }));
        }(this._delegate, t).then((function(t) {
            return new Su(e.firestore, t);
        }));
    }, n.prototype.isEqual = function(t) {
        return Zo(this._delegate, t._delegate);
    }, n.prototype.withConverter = function(t) {
        return new n(this.firestore, t ? this._delegate.withConverter(Nu.nu(this.firestore, t)) : this._delegate.withConverter(null));
    }, n;
}(Ou);
...
function Bu(t) {
    ...
    return (r = this._delegate, i = t, function(t, r) {
        ...
        return t ? new Ou(o, t) : null;
    }));
}

export { hs as C, rs as E, Au as G, Su as H, _u as K, gu as L, q as M, is as T, Iu as W, Cu as Z, Bu as a, qu as c, Ou as e, Fu as i, Tu as j, Uu as o, bu as q, Vu as s, Lu as t, xu as u };
//# sourceMappingURL=prebuilt-a55a34ea-b9c8d348.js.map
